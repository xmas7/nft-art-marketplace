...
/**
 * @title Holds a reference to the Musee Market and communicates fees to marketplaces.
 */
  ...
  NFT721Creator
{
  ...
  /// @notice The Musee market contract address.
  ...
  /**
   * @notice Returns the address of the Musee market contract.
