 ...
 */
contract MUSEECollectionFactory is ICollectionFactory {
  ...
  function createCollection(
    ...
    require(bytes(symbol).length != 0, "MUSEECollectionFactory: Symbol is required");
  ...
  function _updateRolesContract(address _rolesContract) private {
    require(_rolesContract.isContract(), "MUSEECollectionFactory: RolesContract is not a contract");
  ...
  function _updateImplementation(address _implementation) private {
    require(_implementation.isContract(), "MUSEECollectionFactory: Implementation is not a contract");
    ...
    ICollectionContractInitializer(_implementation).initialize(
      ...
      string(abi.encodePacked("Musee Collection Template v", version.toString())),
  ...
  function _updateProxyCallContract(address _proxyCallContract) private {
    require(_proxyCallContract.isContract(), "MUSEECollectionFactory: Proxy call address is not a contract");
