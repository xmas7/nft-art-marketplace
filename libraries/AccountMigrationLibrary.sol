 ...
 * @dev This is shared by both the NFT contracts and MUSEENFTMarket, and the same signature authorizes both.
 */
library AccountMigrationLibrary {
  ...
  /**
   * @notice Confirms the msg.sender is a Musee operator and that the signature provided is valid.
  ...
  function requireAuthorizedAccountMigration(
    ...
    bytes32 hash = abi
      .encodePacked("I authorize Musee to migrate my account to ", _toAsciiString(newAddress))
